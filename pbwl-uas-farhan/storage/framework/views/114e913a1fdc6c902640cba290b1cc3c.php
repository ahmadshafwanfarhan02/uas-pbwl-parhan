                    ...
                    <ul class="nav nav-pills">
                        ...
                        <ul class="nav nav-underline">
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/jenisobat')); ?>">Data jenis alat sekolah</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/obat')); ?>">Data alat sekolah</a>
                                </li>
                                <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\pbwl-uas-dani\resources\views/layouts/app.blade.php ENDPATH**/ ?>